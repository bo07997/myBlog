...
[工程规约]			{#Engineering stipulation}
====================================

(一) 应用分层			{#application stratification-Engineering stipulation}
---------------------
...
(二) 二方库规约			{#bilateral repository protocol-Engineering stipulation}
---------------------
...
(三) 服务器规约			{#Server Protocol-Engineering stipulation}
---------------------
